...
| [writing-hookify-rules](./skills/writing-hookify-rules) | Creating Hookify automation rules with YAML frontmatter, trigger patterns, severity levels, actions, examples, and validation checklists |
