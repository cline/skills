...
| [claude-automation-recommender](./skills/claude-automation-recommender) | Auditing a codebase and recommending Claude Code automations such as hooks, subagents, skills, plugins, MCP servers, and headless workflows |
